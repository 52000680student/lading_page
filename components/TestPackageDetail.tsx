        ...
        if (params.id) {
            ...
            if (foundPackage) {
                ...
                const related = allPackages
                    .filter(pkg => pkg.category === foundPackage.category && pkg.id !== foundPackage.id)
                    .slice(0, 3)
                    .map(pkg => ({
                        ...pkg,
        ...
        <div className="min-h-screen bg-gray-50 pt-24">
            ...
            <div className="bg-white shadow-sm">
                <div className="container py-4">
                    <Link href="/" className="inline-flex items-center text-primary-500 hover:text-primary-600 mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-gray-600">
                                                Số lượng chỉ số: <strong>{testPackage.indicators}</strong>
                                            </span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                        ...
                                        {(testPackage.gender || testPackage.targetGroup) && (
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-sm text-gray-600">
                                                    <strong>{testPackage.gender || testPackage.targetGroup}</strong>
                                                </span>
                                            </div>
                                        )}
                                    </div>
                        ...
                        >
                            ...
                            <div className="prose max-w-none">
                                <p className="text-gray-700 leading-relaxed mb-4">
                                    {testPackage.name} là một gói xét nghiệm toàn diện được thiết kế đặc biệt để
                                    ...
                                    Gói xét nghiệm bao gồm {testPackage.indicators} chỉ số quan trọng giúp đánh giá
                                    tình trạng sức khỏe hiện tại của bạn.
                                </p>
                                <p className="text-gray-700 leading-relaxed">
                                    Với công nghệ hiện đại và đội ngũ chuyên gia giàu kinh nghiệm, chúng tôi cam kết
                                    mang đến kết quả chính xác {testPackage.resultTime.toLowerCase()} để bạn có thể
                                    yên tâm về tình trạng sức khỏe của mình.
                                </p>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-gray-900">Lấy mẫu tại nhà</h3>
                                        <p className="text-sm text-gray-600">Miễn phí lấy mẫu tại nhà, tiện lợi và an toàn</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="w-5 h-5 text-green-500 mt-1" />
                                    <div>
                                        <h3 className="font-medium text-gray-900">Kết quả nhanh chóng</h3>
                                        <p className="text-sm text-gray-600">Nhận kết quả {testPackage.resultTime.toLowerCase()}</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="w-5 h-5 text-green-500 mt-1" />
                                    <div>
                                        <h3 className="font-medium text-gray-900">Chất lượng ISO</h3>
                                        <p className="text-sm text-gray-600">Đạt chứng chỉ ISO 15189:2022</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <CheckCircle className="w-5 h-5 text-green-500 mt-1" />
                                    <div>
                                        <h3 className="font-medium text-gray-900">Tư vấn chuyên môn</h3>
                                        <p className="text-sm text-gray-600">Đội ngũ bác sĩ chuyên nghiệp tư vấn</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="text-center mt-4">
                                <p className="text-sm text-gray-600">
                                    Hoặc gọi <a href="tel:18006271" className="text-primary-500 font-medium">1800 6271</a> để được tư vấn
                                </p>
                            </div>
                        </motion.div>
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Chúng tôi cam kết mang đến cho bạn dịch vụ xét nghiệm chất lượng cao với nhiều ưu điểm vượt trội
                        </p>
                    </motion.div>
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="flex-shrink-0">
                                        <div className="w-12 h-12 bg-primary-50 rounded-full flex items-center justify-center">
                                            <span className="text-primary-500 font-bold text-lg">{advantage.order}</span>
                                        </div>
                                    </div>
                                    <div className="flex-1">
                                        <div className="w-12 h-12 mb-4">
                                            <img src={advantage.icon} alt="" className="w-full h-full object-contain" />
                                        </div>
                                        <p className="text-gray-700 leading-relaxed">
                                            {advantage.title}
                                        </p>
