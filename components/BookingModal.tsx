...
import { X, ArrowLeft, ArrowRight, MapPin, Clock, User, Phone, Home, ChevronDown } from 'lucide-react';
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center">
                ...
                >
                    ...
                    <div className="bg-primary-500 text-white p-6 relative">
                        ...
                        <p className="text-sm mt-2 opacity-90">Bước {currentStep} / {totalSteps}</p>
                    </div>
                    ...
                    <div className="p-6 overflow-y-auto max-h-[60vh]">
                                    ...
                                    <div className="border border-gray-200 rounded-lg p-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button
                                                    onClick={() => updateFormData('service', {
                                                        quantity: Math.max(1, formData.service.quantity - 1)
                                                    })}
                                                    className="w-8 h-8 border border-gray-300 rounded flex items-center justify-center"
                                                >
                                                    -
                                                </button>
                                                <span className="w-8 text-center">{formData.service.quantity}</span>
                                                <button
                                                    onClick={() => updateFormData('service', {
                                        ...
                                        <div className="flex justify-between items-center mt-4 pt-4 border-t">
                                            ...
                                            <span className="font-bold text-primary-500">
                                                {formatPrice(selectedPackage.price * formData.service.quantity)} VND
                                            </span>
                                        </div>
                                    </div>
                                )}
                        ...
                        {currentStep === 2 && (
                            <motion.div
                                ...
                                className="space-y-4"
                            >
                                <h3 className="text-lg font-semibold mb-4">2. Người xét nghiệm</h3>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            onChange={(e) => updateFormData('customer', { specialRequests: e.target.value })}
                                        />
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        {currentStep === 3 && (
                            <motion.div
                                ...
                                className="space-y-4"
                            >
                                <h3 className="text-lg font-semibold mb-4">3. Địa điểm lấy mẫu</h3>
                                ...
                                <div className="space-y-3">
                                    <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-600">Nhập địa chỉ bạn muốn lấy mẫu</div>
                                        </div>
                                    </label>
                        ...
                        {currentStep === 4 && (
                            <motion.div
                                ...
                                className="space-y-4"
                            >
                                <h3 className="text-lg font-semibold mb-4">4. Thời gian lấy mẫu</h3>
                                ...
                                <div className="space-y-3">
                                    <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-600">Chúng tôi sẽ liên hệ để sắp xếp thời gian phù hợp</div>
                                        </div>
                                    </label>
                                    ...
                                    <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-600">Chọn thời gian cụ thể bạn muốn lấy mẫu</div>
                                        </div>
                                    </label>
                    ...
                    <div className="p-6 border-t bg-gray-50">
                        ...
                        <div className="text-center mt-4">
                            <p className="text-sm text-gray-600">
                                Hotline hỗ trợ: <span className="font-medium text-primary-500">1800 6271</span>
                            </p>
                        </div>
                    </div>
                </motion.div>
