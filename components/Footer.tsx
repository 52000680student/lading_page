    ...
    <footer id="contact" className="bg-dark-footer text-white py-16">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* About Us */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-white">Về MedNova</h3>
            <p className="text-gray-300 leading-relaxed">
              MedNova là nhà cung cấp hàng đầu các dịch vụ xét nghiệm y tế tiện
              lợi, đáng tin cậy. Chúng tôi cam kết làm cho dịch vụ chăm sóc sức
              khỏe dễ tiếp cận và thuận tiện cho mọi người.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-gray-300">
                  STH 39.11 Đường Thích Quảng Đức, Hà Quang 1, phường Phước Hải
                  ,Nha Trang , Khánh Hòa
                </p>
              </div>
              <div className="flex items-center gap-3">
