                ...
                <div className="container">
                    <div className="flex overflow-x-auto">
                        <button
                            ...
                            className={`flex items-center gap-2 px-6 py-4 text-sm font-medium whitespace-nowrap transition-colors border-b-2 ${activeMainTab === 'packages'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-6 py-4 text-sm font-medium whitespace-nowrap transition-colors border-b-2 ${activeMainTab === 'services'
                                    ? 'text-primary-500 border-primary-500'
                                    : 'text-gray-500 border-transparent hover:text-gray-700'
                                }`}
                        >
